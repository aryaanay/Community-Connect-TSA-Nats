...
const sources = [
  ...
  { resource: 'Web Speech API (SpeechSynthesis)', type: 'Browser API', license: 'W3C Standard (free)', url: 'developer.mozilla.org/en-US/docs/Web/API/SpeechSynthesis' },
  { resource: 'library3.jpg - 2019 timeline card and resources parallax', type: 'Photography', license: 'Unsplash License (free)', url: 'unsplash.com/photos/NIJuEQw0RKg' },
  { resource: 'foodpantry5.jpg - 2020 timeline card and resources parallax', type: 'Photography', license: 'Unsplash License (free)', url: 'unsplash.com/photos/Z8UgB80_46w' },
  ...
  { resource: 'heartwithhands6.jpg - 2022 timeline card and resources parallax', type: 'Photography', license: 'Unsplash License (free)', url: 'unsplash.com/photos/cAtzHUz7Z8g' },
  { resource: 'community7.jpg - 2023 timeline card and resources parallax', type: 'Photography', license: 'Pexels License (free)', url: 'beginatbothell.com/wp-content/uploads/2023/09/pexels-kelly-2876511.jpg' },
  ...
  { resource: 'playground1.jpg - 2026 timeline card and resources parallax', type: 'Photography', license: 'Unsplash License (free)', url: 'unsplash.com/photos/8NymO2MErVI' },
  { resource: 'cleanup4.jpg - 2025 timeline card and resources parallax', type: 'Photography', license: 'Unsplash License (free)', url: 'unsplash.com/photos/CIItgnBEOgw' },
  ...
  { resource: 'garden2.jpg - mission section and resources parallax', type: 'Photography', license: 'Unsplash License (free)', url: 'unsplash.com/photos/bY_q4VodUc0' },
            ...
            <div className="rounded-2xl overflow-hidden border p-6" style={{ backgroundColor: CARD, borderColor: BORDER }}>
              ...
              <ul className="grid sm:grid-cols-2 gap-2">
                {[
                  ...
                  'Reduced motion mode',
                  'Page zoom up to 200%',
                  'Text-to-speech via Web Speech API (click any text to hear it)',
                ].map((item) => (
