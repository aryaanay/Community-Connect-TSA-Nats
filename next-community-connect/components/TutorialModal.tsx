...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Stay up to date with workshops, volunteer days, and local activities. Click any event to see its full description, time, location, and category.',
    accent: '#8B5CF6',
  ...
  },
  {
    ...
    body: 'Contribute to causes like the Bothell Food Bank, Youth Mentorship, and Senior Companions. Every simulated donation helps demonstrate community support.',
    accent: '#EC4899',
    accentBg: 'rgba(236,72,153,0.12)',
    link: { label: 'Browse Causes', href: '/wishlist' },
  },
  {
    emoji: '⚙️',
    badge: 'Settings',
